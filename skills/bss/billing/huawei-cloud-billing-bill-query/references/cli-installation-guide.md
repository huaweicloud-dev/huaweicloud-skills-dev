...
> The AK/SK must belong to the account whose bills you want to query.
...
```bash
cd <skill-dir>
python3 scripts/query_bills.py --action fee-records --bill-cycle 2026-07
```
