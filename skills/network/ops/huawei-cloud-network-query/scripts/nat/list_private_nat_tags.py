...
from huaweicloudsdknat.v2.model import ListPrivateNatTagsRequest
...
# 参数
parser = argparse.ArgumentParser(description="查询私网NAT网关项目标签")
...
try:
    ...
    if not tags:
        print(f"没有找到私网NAT网关项目标签 (区域: {Region})")
        exit(0)
    ...
    print(f"nat.list_private_nat_tags 查询失败: {e}")
    exit(1)
