...
from huaweicloudsdknat.v2.model import ShowPrivateNatTagsRequest
...
# 参数
parser = argparse.ArgumentParser(description="查询指定私网NAT网关的标签")
parser.add_argument("--project_id", type=str, default=None, help="项目 ID，不传时自动通过 IAM API 获取")
parser.add_argument("--region", type=str, help="区域，默认 cn-north-4")
parser.add_argument("--resource_id", type=str, required=True, help="私网NAT网关ID，可通过 list_private_nats.py 获取")
...
try:
    ...
    print(f"nat.show_private_nat_tags 查询失败: {e}")
    exit(1)
