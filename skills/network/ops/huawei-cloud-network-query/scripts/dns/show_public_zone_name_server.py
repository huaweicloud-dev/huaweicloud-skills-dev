...
from huaweicloudsdkdns.v2.model import ShowPublicZoneNameServerRequest
from huaweicloudsdkdns.v2.region.dns_region import DnsRegion

AK, SK, Region, SecurityToken = load_credentials()

parser = argparse.ArgumentParser(description="查询公网域名的名称服务器")
...
try:
    ...
    print(f"dns.show_public_zone_name_server 查询失败: {e}")
    exit(1)
