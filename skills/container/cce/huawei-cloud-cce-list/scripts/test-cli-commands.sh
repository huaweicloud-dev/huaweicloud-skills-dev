#!/usr/bin/env bash
# test-cli-commands.sh — Functional test for huawei-cloud-cce-list skill
set -uo pipefail
...
REGION="${CCE_REGION:-$REGION}"

echo "=== CCE Cluster List Skill Test Script ==="
