...
A successful run prints the project list in JSON format.
...
| `User has no permission` | IAM policy missing `iam:projects:listProjects` — see `references/iam-policies.md` |
