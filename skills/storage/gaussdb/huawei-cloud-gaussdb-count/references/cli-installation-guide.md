...
## Verify GaussDB service availability

```bash
hcloud GaussDBforopenGauss ListInstances --cli-region=cn-north-4 --help
hcloud GaussDB ListGaussMySqlInstances --cli-region=cn-north-4 --help
```
